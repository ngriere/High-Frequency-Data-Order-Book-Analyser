 ...
 * @author hugo
 */
public class ModelOrderBookAsk extends AbstractTableModel implements Listener {

    ArrayList<DataOrderBook> liste;
    private final String[] entetes = {"Ask Price", "Shares"};
    private ArrayList<AskListener> listeners;

    public ModelOrderBookAsk() {
        super();
        this.liste = new ArrayList<>();
        listeners = new ArrayList<AskListener>();
    }

    public void add(AskListener listener) {
        this.listeners.add(listener);
    }

    public void fireListener(DataOrderBook data) {
        for (AskListener l : this.listeners) {
            l.handleBestAsk(data);
        }
    }
